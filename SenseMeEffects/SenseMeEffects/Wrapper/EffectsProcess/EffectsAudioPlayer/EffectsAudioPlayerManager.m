...
st_result_t _audio_modul_state_change_callback(st_handle_t handle,
                                               const st_effect_module_info_t* p_module_info){
...
st_result_t _package_state_change_callback(st_handle_t handle, const st_effect_package_info_t* p_package_info){

...
@interface EFEffectsCollectionView ()<UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, EFEffectsContentViewDelegate>
...
@property (nonatomic, assign) EFStatusManagerSingletonMode mode;
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [EFGlobalSingleton sharedInstance].isPortraitOnly = [selectedModel.efName isEqualToString:@"GAN"];
...
- (EFEffectsContentView *)contentView {
    if (!_contentView) {
        _contentView = [[EFEffectsContentView alloc] initWithFrame:CGRectZero mode:self.mode];
...
#pragma mark - EFEffectsContentViewDelegate

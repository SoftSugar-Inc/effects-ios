...
- (void)setUI {
    ...
    UIView *protectView = [[UIView alloc] initWithFrame:CGRectZero];
    protectView.backgroundColor = UIColor.clearColor;
    [self addSubview:protectView];
...
- (EFMakeupFilterBeautyContentView *)contentView {
    if (!_contentView) {
        _contentView = [[EFMakeupFilterBeautyContentView alloc]initWithFrame:CGRectZero withType:self.itemType model:self.mode];

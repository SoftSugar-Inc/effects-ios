...
- (NSString *)localizedStringForKey:(NSString *)key value:(NSString *)value table:(NSString *)tableName {
    ...
    if (!currentLanguage) {
        ...
        if ([appleLanguages.firstObject containsString:@"zh-Hans"]) {
            currentLanguage = @"zh-Hans";
        } else if ([appleLanguages.firstObject containsString:@"ja"]) {
            currentLanguage = @"ja";
        } else if ([appleLanguages.firstObject containsString:@"ko"]) {
            currentLanguage = @"ko";
        } else {
            currentLanguage = @"en";
        }
